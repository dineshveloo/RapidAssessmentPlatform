...
//AddonsNavPage replaced wih Signin Page
  ...
  render() {
    return (
      ...
      <Switch>
        ...
        <Route path='/modal-examples' component={ModalExamplesPage} /> */}
